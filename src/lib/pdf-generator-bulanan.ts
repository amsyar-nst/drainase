      ...
      <table>
        <thead>
          <tr>
            ...
            <th rowspan="3" class="panjang-col">PANJANG<br/>(M)</th>
            <th rowspan="3" class="volume-col">VOLUME (M³)</th>
          ...
          ${kegiatansWithImages.map((kegiatan, kegiatanIndex) => `
            ${kegiatan.aktifitasPenangananDetails.map((detail, detailIndex) => `
              <tr>
                ...
                ${detailIndex === 0 ? `
                  <td class="center" rowspan="${kegiatan.aktifitasPenangananDetails.length}">${kegiatan.panjangPenanganan || '-'}</td>
                  <td class="center" rowspan="${kegiatan.aktifitasPenangananDetails.length}">${kegiatan.volumeGalian || '-'}</td>
                ` : ''}
                <td>
